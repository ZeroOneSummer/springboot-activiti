...
public class DateUtil {
	...
	public final static SimpleDateFormat sdfShort = new SimpleDateFormat("yyyyMMdd");
	public final static SimpleDateFormat sdfLong = new SimpleDateFormat("yyyy-MM-dd");
	public final static SimpleDateFormat YYYY_MM_DD_HH = new SimpleDateFormat("yyyy-MM-dd HH");
	public final static SimpleDateFormat sdfLongCn = new SimpleDateFormat("yyyy年MM月dd日");
	public final static SimpleDateFormat sdfShortU = new SimpleDateFormat("MMM dd", Locale.ENGLISH);
	public final static SimpleDateFormat sdfLongU = new SimpleDateFormat("MMM dd,yyyy",
			Locale.ENGLISH);
	public final static SimpleDateFormat sdfLongTime = new SimpleDateFormat("yyyyMMddHHmmss");
	public final static SimpleDateFormat sdfLongTimePlus = new SimpleDateFormat(
			"yyyy-MM-dd HH:mm:ss");
	public static SimpleDateFormat sdfShortLongTimePlusCn = new SimpleDateFormat(
			"yyyy年MM月dd日 HH:mm");
	public final static SimpleDateFormat sdfLongTimePlusMill = new SimpleDateFormat(
			"yyyyMMddHHmmssSSSS");
	public final static SimpleDateFormat sdfLongTimePlusUTC = new SimpleDateFormat(
			"yyyy-MM-dd'T'HH:mm:ss");
	public final static SimpleDateFormat sdfMd = new SimpleDateFormat("MM月dd日");
	public final static SimpleDateFormat sdf24HS = new SimpleDateFormat("HHmmss");
	public final static SimpleDateFormat sdfHHmm = new SimpleDateFormat("HHmm");
	private final static long DAY_IN_MILLISECOND = 0x5265c00L;
	public final static DateFormat format = new SimpleDateFormat("yyyy年MM月dd日 hh");
	 ...
	 * @throws Exception
	 */
	public static long getsdfLongTime(String value) {
		try {
			return sdfLongTime.parse(value).getTime();
		} catch (Exception e) {
			e.printStackTrace();
			return 0L;
		}
	 ...
	 * @throws Exception
	 */
	public static String getYYYY_MM_DDD(Date date) throws Exception {
		try {
			return sdfShort.format(date);
		} catch (Exception e) {
			throw e;
	...
	/**
	 * Returns a Date set just to Noon, to the closest possible millisecond of the
	 * day. If a null day is passed in, a new Date is created. nnoon (00m 12h 00s)
	 */
	...
	/**
	 * Returns a string the represents the passed-in date parsed according to the
	 * passed-in format. Returns an empty string if the date or the format is null.
	 **/
	...
	/**
	 * Returns true if endDate is after startDate or if startDate equals endDate or
	 * if they are the same date. Returns false if either value is null.
	 **/
	 ...
	 * Returns false if either value is null. If equalOK, returns true if the dates
	 * are equal.
	 **/
	 ...
	 *
	 * @param date
	 * @param type 1: HH:mm 2: MM-DD HH:mm
	 * @return
	 */
	 ...
	 * 根据年 月 获取对应的月份 天数
	 */
	public static int getDaysByYearMonth(final int year, final int month) {
	...
	/**
	 * 获取今天是星期几，比如星期一返回返回的2 ，星期天返回的是1 星期六是7
	 *
	 * @return
	 */
	public final static int getDAY_OF_WEEK() {
		return Calendar.getInstance().get(Calendar.DAY_OF_WEEK);
	}
	
	public final static int getHOUR_OF_DAY() {
		return Calendar.getInstance().get(Calendar.HOUR_OF_DAY);
	}
	
	public final static int getNowMINUTE() {
	 ...
	 * @return
	 */
	public final static int getHours(Date date) {
		Calendar calendar = Calendar.getInstance();
	...
	public static Date addTime(final Date date, final int value) {
		...
		nowTime.add(Calendar.MINUTE, value);// 分钟后的时间
	...
	public static int getDayEndSecond() {
	...
	public static void main(String[] args) throws ParseException {
		System.out.println(timestamp2Date(new Date()));
	}
	 ...
	 */
	public static Date timestamp2Date(Date value) throws ParseException {
		return sdfLongTime.parse(sdfLongTime.format(value));
	}
}
